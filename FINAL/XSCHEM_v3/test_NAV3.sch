...
"}
C {a_zonetic2026/XSCHEM_v3/GRADIENT_NAV2_V3.sym} 0 0 0 0 {name=xnav}
...
*   x2 S1N S1P VDD X2 S4N Y2 Z2 S4P VSS S2N S2P GRADIENT2
*   x3 S1N S1P VDD X3 S4N Y3 Z3 S4P VSS S3N S3P GRADIENT2
*   x4 S2N S2P VDD X4 S4N Y4 Z4 S4P VSS S3N S3P GRADIENT2
*
...
* --- cadena 2: X=S1  Y=S4  Z=S2
XA21 GND VDDR S1P SX2r S1N OPAM_LIN_flat_V2
XA22 GND VDDR S4P SY2r S4N OPAM_LIN_flat_V2
...
* --- cadena 3: X=S1  Y=S4  Z=S3
XA31 GND VDDR S1P SX3r S1N OPAM_LIN_flat_V2
XA32 GND VDDR S4P SY3r S4N OPAM_LIN_flat_V2
XA33 GND VDDR S3P SZ3r S3N OPAM_LIN_flat_V2
