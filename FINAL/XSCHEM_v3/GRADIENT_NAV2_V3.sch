...
C {lab_pin.sym} -20 560 0 0 {name=p52 lab=S3N}
C {lab_pin.sym} -20 580 0 0 {name=p53 lab=S3P}
...
C {lab_pin.sym} -20 130 0 0 {name=p80 lab=S4N}
C {lab_pin.sym} -20 150 0 0 {name=p81 lab=S4P}
C {lab_pin.sym} -20 170 0 0 {name=p82 lab=S2N}
C {lab_pin.sym} -20 190 0 0 {name=p83 lab=S2P}
C {lab_pin.sym} -20 280 0 0 {name=p84 lab=S1N}
C {lab_pin.sym} -20 300 0 0 {name=p85 lab=S1P}
C {lab_pin.sym} -20 320 0 0 {name=p86 lab=S4N}
C {lab_pin.sym} -20 340 0 0 {name=p87 lab=S4P}
C {lab_pin.sym} -20 360 0 0 {name=p88 lab=S3N}
C {lab_pin.sym} -20 380 0 0 {name=p89 lab=S3P}
