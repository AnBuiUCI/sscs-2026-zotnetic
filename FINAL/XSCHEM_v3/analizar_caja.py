...
NETLISTS = {
    #  EXPERIMENTO: la rama "v" es aqui la v3, el reparto de puertos
    #  reordenado. La "t" sigue siendo el top que esta en el die, para que
    #  las dos se midan lado a lado en el mismo barrido.
    "v": Path("/foss/designs/a_zonetic2026/XSCHEM_v3/simulation/"
              "GRADIENT_NAV2_V3.spice"),
