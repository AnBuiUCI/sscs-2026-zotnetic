...
"}
C {devices/vsource.sym} 20 -120 0 0 {name=V5 value="AC 10u"
}
C {devices/lab_wire.sym} 20 -150 0 0 {name=p13 sig_type=std_logic lab=va}
...
"}
C {devices/lab_wire.sym} 20 -90 0 0 {name=p1 sig_type=std_logic lab=vb}
