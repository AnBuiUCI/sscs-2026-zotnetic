...
N -200 -60 -180 -60 {lab=SXN}
N -200 -20 -180 -20 {lab=SXP}
N -200 100 -180 100 {lab=SYN}
N -200 140 -180 140 {lab=SYP}
N -200 260 -180 260 {lab=SZN}
N -200 300 -180 300 {lab=SZP}
N -120 340 -120 350 {lab=VSS}
N -120 210 -120 220 {lab=VDD}
N 130 340 130 350 {lab=VSS}
N 130 210 130 220 {lab=VDD}
N -120 180 -120 190 {lab=VSS}
N -120 50 -120 60 {lab=VDD}
N 130 180 130 190 {lab=VSS}
N 130 50 130 60 {lab=VDD}
N 130 20 130 30 {lab=VSS}
N 130 -110 130 -100 {lab=VDD}
N -120 20 -120 30 {lab=VSS}
N -120 -110 -120 -100 {lab=VDD}
N -20 -40 0 -40 {lab=SX}
N 0 -60 0 -40 {lab=SX}
N -0 -60 70 -60 {lab=SX}
...
C {a_zonetic2026/XSCHEM/OPAM/COMP.sym} 130 -40 0 0 {name=x4}
C {a_zonetic2026/XSCHEM/OPAM/COMP.sym} 130 120 0 0 {name=x5}
C {a_zonetic2026/XSCHEM/OPAM/COMP.sym} 130 280 0 0 {name=x6}
C {a_zonetic2026/XSCHEM/DECODER/DECODER.sym} 440 140 0 0 {name=x7}
C {ipin.sym} -200 -60 0 0 {name=p1 lab=SXN}
C {ipin.sym} -200 -20 0 0 {name=p2 lab=SXP
}
...
C {ipin.sym} -200 100 0 0 {name=p9 lab=SYN}
C {ipin.sym} -200 140 0 0 {name=p10 lab=SYP
}
C {ipin.sym} -200 260 0 0 {name=p11 lab=SZN}
C {ipin.sym} -200 300 0 0 {name=p12 lab=SZP
}
C {lab_pin.sym} -120 210 2 0 {name=p6 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -120 350 2 0 {name=p13 sig_type=std_logic lab=VSS}
...
C {lab_pin.sym} -120 50 2 0 {name=p16 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -120 190 2 0 {name=p17 sig_type=std_logic lab=VSS}
...
C {lab_pin.sym} -120 -110 2 0 {name=p22 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -120 30 2 0 {name=p23 sig_type=std_logic lab=VSS}
...
C {a_zonetic2026/XSCHEM/OPAM/OPAM_LIN.sym} -80 -40 0 0 {name=x8}
C {a_zonetic2026/XSCHEM/OPAM/OPAM_LIN.sym} -80 120 0 0 {name=x1}
C {a_zonetic2026/XSCHEM/OPAM/OPAM_LIN.sym} -80 280 0 0 {name=x2}
