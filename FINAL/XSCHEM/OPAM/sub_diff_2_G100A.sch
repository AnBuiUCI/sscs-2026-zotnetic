...
spiceprefix=X
m=1}
C {devices/ipin.sym} -760 -660 0 0 {name=p6 lab=bias1}
C {devices/ipin.sym} -760 -580 0 0 {name=p7 lab=bias2}
C {devices/ipin.sym} -760 -240 0 0 {name=p8 lab=bias3}
C {devices/ipin.sym} -750 -160 0 0 {name=p9 lab=bias4}
C {devices/lab_pin.sym} 850 -490 0 0 {name=pMD10 sig_type=std_logic lab=G_OUT_P}
C {devices/lab_pin.sym} 980 -490 0 0 {name=pMD11 sig_type=std_logic lab=G_OUT_P}
C {devices/lab_pin.sym} 1020 -520 0 0 {name=pMD12 sig_type=std_logic lab=G_OUT_P}
C {devices/lab_pin.sym} 1020 -460 0 0 {name=pMD13 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1020 -490 0 0 {name=pMD14 sig_type=std_logic lab=VSS}
C {symbols/nfet_06v0.sym} 1000 -490 0 0 {name=MD1
L=1.0u
W=6.0u
nf=1
m=1
