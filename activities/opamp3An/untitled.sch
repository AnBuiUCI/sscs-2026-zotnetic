...
N 460 -180 670 -180 {lab=vout}
N 560 -180 670 -180 {lab=vout}
N 460 -210 530 -210 {lab=vinp}
N 530 -240 530 -210 {lab=vinp}
N 590 -210 670 -210 {lab=vout}
N 590 -210 590 -180 {lab=vout}
N 560 -180 560 -160 {lab=vout}
N 380 -210 420 -210 {lab=VG}
N 710 -210 750 -210 {lab=VG}
N 130 150 340 150 {lab=VSS}
N 230 150 340 150 {lab=VSS}
N 230 70 230 150 {lab=VSS}
N 130 210 340 210 {lab=vinn}
N 230 210 340 210 {lab=vinn}
N 130 180 200 180 {lab=VSS}
N 200 150 200 180 {lab=VSS}
N 260 180 340 180 {lab=vinn}
N 260 180 260 210 {lab=vinn}
...
C {vsource.sym} -250 190 0 0 {name=VGATE value=4.5 savecurrent=false}
...
C {lab_pin.sym} 230 220 0 0 {name=p18 sig_type=std_logic lab=vinn}
