...
C {vsource.sym} -250 320 0 0 {name=V3 value=5 savecurrent=false}
C {vsource.sym} -160 320 0 0 {name=V4 value=5 savecurrent=false}
...
.control
run
meas tran b1 find i(Vmeas) at=199ms
meas tran b2 find v(VDD) at=199ms
let b3 = b1/b2
echo \\"$&b1 $&b2 $&b3\\" >> /foss/designs/sscs-2026-zotnetic/activities/opamp3AKAM/simulation_results/resistance.txt
.endc"
